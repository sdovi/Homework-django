...
class maintext(models.Model):
    text0 = models.TextField("текст обычный", max_length=1000)
    text1 = models.TextField("текст жирный", max_length=1000)
    text2 = models.TextField("текст обычный", max_length=1000)
    text3 = models.TextField("текст обычный", max_length=1000)
    text4 = models.TextField("текст жирный", max_length=1000)
    text5 = models.TextField("текст обычный", max_length=1000)
    text6 = models.TextField("текст обычный", max_length=1000)
    text7 = models.TextField("текст обычный", max_length=1000)
    text8 = models.TextField("текст обычный", max_length=1000)
    text9 = models.TextField("текст обычный", max_length=1000)
    text10 = models.TextField("текст обычный", max_length=1000)
    text11 = models.TextField("текст обычный", max_length=1000)
    text12 = models.TextField("текст обычный", max_length=1000)
    text13 = models.TextField("текст обычный", max_length=1000)
    text14 = models.TextField("текст жирный", max_length=1000)
    text15 = models.TextField("текст обычный", max_length=1000)
    text16 = models.TextField("текст обычный", max_length=1000)
    text17 = models.TextField("текст обычный", max_length=1000)
    text18 = models.TextField("текст обычный", max_length=1000)
    text19 = models.TextField("текст обычный", max_length=1000)
